...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('https://spwn-js.glitch.me/spwn.wasm', location.href);
    }
    const imports = {};
    imports.wbg = {};
...
resolve({output: txt.split('\n').shift(), levelstring: levelstring});
        });  
